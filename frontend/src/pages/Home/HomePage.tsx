    ...
    <>
      ...
      <div className="container m-auto p-6 flex flex-col gap-12 justify-center">
        <div className="flex flex-col items-center text-center text-[#434343] gap-4">
          ...
          <p className="max-w-3xl font-normal">On-demand oracles, real-time data, trustless insights. SnapData brings the real world to your dApp, one snap at a time. Ready to power your dApp? Start snapping now.</p>
        </div>
